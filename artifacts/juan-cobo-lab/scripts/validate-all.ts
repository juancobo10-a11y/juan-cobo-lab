...
const suites: Suite[] = [
  ...
  },
  {
    name: "S-022",
    cmd: "pnpm",
    args: ["exec", "tsx", "src/evidence-evaluation/__tests__/validacion_s022.ts"],
  },
  {
    name: "S-023",
    cmd: "pnpm",
  ...
  },
  {
    name: "S-025",
    cmd: "pnpm",
    args: ["exec", "tsx", "src/understanding-case/__tests__/validacion_s025.ts"],
  },
  {
    name: "S-026",
    cmd: "pnpm",
    args: ["exec", "tsx", "src/knowledge-sources/__tests__/validacion_s026.ts"],
  },
  {
    name: "S-027",
    cmd: "pnpm",
    args: ["exec", "tsx", "src/contributions/__tests__/validacion_s027.ts"],
  },
  {
    name: "Smoke",
    cmd: "pnpm",
...
console.log(
  `\n${C.bold}HELIOS — Validation Suite${C.reset}  ${C.dim}(S-026)${C.reset}\n` +
  "─".repeat(44) + "\n"
);
